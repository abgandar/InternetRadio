...
#define SIP_USER        "620"                   // Benutzername aus der Fritzbox Konfiguration
#define SIP_PASSWD      "vNW*5d&gH;NZQQ6"       // Passwort aus der Fritz Box Konfiguration
...
// Pin Definitionen
//#define KLINGEL_PIN     3                       // Pin auf dem der Klingeltaster liegt
//#define TUER_PIN        50                      // Pin auf dem der Türöffner liegt (50 is low by default on by BBB)
//#define GLOCKE_PIN      51                      // Pin auf dem die Türglocke liegt (51 is low by default on my BBB)
